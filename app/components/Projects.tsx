...
export default function Projects() {
  const projectsData = [
    {
      title: 'EduFlow - Academic Project Planner',
      ...
      situation: 'Mahasiswa D3 PENS sering mengalami kendala koordinasi proyek kelompok karena kepadatan tugas praktikum dan ketiadaan platform pelacakan tersentralisasi.',
      task: 'Bertindak sebagai Product Owner & Lead UI/UX, saya dituntut mengidentifikasi kebutuhan inti, memetakan User Stories, serta merancang rancang-bangun antarmuka hingga pengkodean frontend.',
      action: 'Menyusun spesifikasi PRD produk, membuat desain UI beresolusi tinggi di Figma dengan micro-interactions, serta memprogram aplikasi frontend web yang terintegrasi secara real-time dengan Supabase.',
      result: 'Berhasil meluncurkan prototipe yang mempercepat koordinasi tim proyek mahasiswa, mengurangi redudansi komunikasi tugas kelompok hingga 35%, dan mendapatkan umpan balik positif dari rekan angkatan.',
      codeLink: '#',
      demoLink: '#',
    },
    {
      title: 'DesignOps Hub - Figma to Code Automation',
      subtitle: 'Developer Tool',
      tags: ['TypeScript', 'Tailwind CSS v4', 'Figma API', 'Node.js'],
      duration: '3 Months',
      location: 'Independent Project',
      situation: 'Proses handoff aset desain visual dari desainer Figma ke tim software engineer sering memicu ketidakkonsistenan ukuran, warna, dan memakan waktu slicing manual.',
      task: 'Merumuskan standarisasi konversi Token Desain menjadi utility class yang siap disematkan langsung pada komponen web React.',
      action: 'Mengembangkan skrip otomatisasi berbasis Node.js yang membaca layout JSON Figma API, mem-parsing variabel warna, spasi, dan tipografi, lalu mengekspornya langsung ke format stylesheet.',
      result: 'Memangkas waktu slicing antarmuka pengembang web hingga 40%, mengeliminasi 100% inkonsistensi warna dan font antara tim desain dan engineering.',
      codeLink: '#',
      demoLink: '#',
    },
  ];
